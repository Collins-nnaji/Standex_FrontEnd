export const questions = {
  learningPath: [
    ...
    { id: 3, text: "Preferred learning format?", type: 'dropdown', multiple: true, options: ['Videos', 'Articles', 'Interactive Exercises'] },
    { id: 4, text: "What are your career goals?", type: 'text' },
    { id: 5, text: "What programming languages are you interested in?", type: 'dropdown', options: ['Python', 'JavaScript', 'Java', 'C++', 'C#', 'Ruby', 'Go', 'Swift'] },
    { id: 6, text: "What type of projects interest you?", type: 'dropdown', options: ['Web Development', 'Mobile Development', 'Data Science', 'Machine Learning', 'Cybersecurity', 'Game Development', 'AI/ML', 'Blockchain', 'IoT'] },
    { id: 7, text: "Do you have any preferred learning platforms?", type: 'dropdown', options: ['Coursera', 'Udemy', 'edX', 'Pluralsight', 'Khan Academy', 'LinkedIn Learning'] },
    { id: 8, text: "Do you need certification?", type: 'dropdown', options: ['Yes', 'No'] },
    { id: 9, text: "What is your preferred learning style?", type: 'dropdown', options: ['Self-paced', 'Instructor-led', 'Group learning'] },
    { id: 10, text: "What is your budget for learning?", type: 'dropdown', options: ['Free', 'Under $50', 'Under $100', 'No budget limit'] },
  ],
  skillAssessment: [
    { id: 1, text: "Which area do you want to assess?", type: 'dropdown', options: ['Web Development', 'Data Science', 'Machine Learning', 'Cybersecurity', 'Cloud Computing', 'DevOps', 'Mobile Development', 'AI/ML', 'Blockchain'] },
    ...
    { id: 4, text: "What type of assessment do you prefer?", type: 'dropdown', options: ['Multiple Choice', 'Coding Challenges', 'Projects'] },
    { id: 5, text: "What is your goal for this assessment?", type: 'dropdown', options: ['Identify strengths and weaknesses', 'Prepare for a job interview', 'Get certified'] },
  ...
  projectBuilder: [
    { id: 1, text: "What type of project are you interested in?", type: 'dropdown', options: ['Web Application', 'Mobile Application', 'Data Analysis', 'Machine Learning Model', 'Game Development', 'IoT Project', 'Blockchain Application', 'AI/ML Project'] },
    ...
    { id: 4, text: "Do you have a preferred programming language for this project?", type: 'dropdown', options: ['Python', 'JavaScript', 'Java', 'C++', 'C#', 'Ruby', 'Go', 'Swift'] },
    ...
    { id: 7, text: "Do you have a specific audience for your project?", type: 'dropdown', options: ['General Public', 'Business', 'Educational'] },
  ...
  resourceLibrary: [
    { id: 1, text: "Preferred resource type?", type: 'dropdown', options: ['Books', 'Articles', 'Video Tutorials', 'Online Courses', 'Webinars'] },
    { id: 2, text: "Preferred language?", type: 'dropdown', options: ['English', 'Spanish', 'French', 'German', 'Chinese'] },
    ...
    { id: 7, text: "What is your learning goal?", type: 'dropdown', options: ['Gain new skills', 'Deepen existing knowledge', 'Prepare for certification'] },
    { id: 8, text: "Do you need resources in a specific format?", type: 'dropdown', options: ['PDF', 'ePub', 'Kindle'] },
  ...
  careerAdvice: [
    { id: 1, text: "What is your current job role?", type: 'dropdown', options: ['Student', 'Entry-level Professional', 'Mid-level Professional', 'Senior Professional'] },
    { id: 2, text: "What are your career aspirations?", type: 'text' },
    { id: 3, text: "Preferred advice format?", type: 'dropdown', options: ['Articles', 'Videos', 'Mentorship'] },
    ...
    { id: 8, text: "What is your preferred industry?", type: 'dropdown', options: ['Technology', 'Finance', 'Healthcare', 'Education'] },
    { id: 9, text: "Do you have a target job role in mind?", type: 'dropdown', options: ['Software Developer', 'Data Scientist', 'Product Manager'] },
