export const questions = {
  learningPath: [
    ...
    { id: 6, text: "If yes, which programming languages are you interested in?", type: 'dropdown', multiple: true, options: ['Python', 'JavaScript', 'Java', 'C++', 'C#', 'Ruby', 'Go', 'Swift', 'Rust', 'Kotlin'], dependsOn: { questionId: 5, value: 'Yes' } },
    { id: 7, text: "What type of projects interest you?", type: 'dropdown', multiple: true, options: ['Web Development', 'Mobile Development', 'Data Science', 'Machine Learning', 'Cybersecurity', 'Game Development', 'AI/ML', 'Blockchain', 'IoT', 'DevOps', 'None of the above'] },
    { id: 8, text: "Do you have any preferred learning platforms?", type: 'dropdown', multiple: true, options: ['Coursera', 'Udemy', 'edX', 'Pluralsight', 'Khan Academy', 'LinkedIn Learning', 'YouTube', 'FreeCodeCamp', 'Codecademy', 'None'] },
    { id: 9, text: "Do you need certification?", type: 'dropdown', options: ['Yes', 'No', 'Not Sure'] },
    { id: 10, text: "What is your preferred learning style?", type: 'dropdown', multiple: true, options: ['Self-paced', 'Instructor-led', 'Group learning', 'Peer learning', 'Mentorship'] },
    { id: 11, text: "What is your budget for learning?", type: 'dropdown', options: ['Free', 'Under $50', 'Under $100', 'No budget limit'] },
    { id: 12, text: "Are there specific topics or skills you want to learn about?", type: 'text' },
    { id: 13, text: "Do you have any preferred resources or links for learning?", type: 'text' },
  ],
  skillAssessment: [
